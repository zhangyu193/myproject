...
import { DEFAULT_COLOR_CASE } from '@de/views/chart/components/editor/util/chart'
import { useI18n } from '@de/hooks/web/useI18n'
import DeSlider from '@de/components/dashboard/subject-setting/pre-subject/Slider.vue'
...
import ViewSimpleTitle from '@de/components/dashboard/subject-setting/dashboard-style/ViewSimpleTitle.vue'
import FilterStyleSimpleSelector from '@de/components/dashboard/subject-setting/dashboard-style/FilterStyleSimpleSelector.vue'
