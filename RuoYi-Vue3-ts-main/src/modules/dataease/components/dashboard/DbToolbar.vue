...
import dvBatch from '@de/assets/svg/dv-batch.svg'
import dvDashboard from '@de/assets/svg/dv-dashboard.svg'
import dvHidden from '@de/assets/svg/dv-hidden.svg'
import dvFilter from '@de/assets/svg/dv-filter.svg'
import dvMedia from '@de/assets/svg/dv-media.svg'
import dvMoreCom from '@de/assets/svg/dv-more-com.svg'
import dvTab from '@de/assets/svg/dv-tab.svg'
import dvText from '@de/assets/svg/dv-text.svg'
import dvView from '@de/assets/svg/dv-view.svg'
import icon_params_setting from '@de/assets/svg/icon_params_setting.svg'
import icon_phone_outlined from '@de/assets/svg/icon_phone_outlined.svg'
import icon_copy_filled from '@de/assets/svg/icon_copy_filled.svg'
import icon_left_outlined from '@de/assets/svg/icon_left_outlined.svg'
import icon_undo_outlined from '@de/assets/svg/icon_undo_outlined.svg'
import icon_redo_outlined from '@de/assets/svg/icon_redo_outlined.svg'
import icon_pc_fullscreen from '@de/assets/svg/icon_pc_fullscreen.svg'
import dvPreviewOuter from '@de/assets/svg/dv-preview-outer.svg'
import dvRecoverOutlined from '@de/assets/svg/dv-recover_outlined.svg'
import dvCancelPublish from '@de/assets/svg/icon_undo_outlined.svg'
...
import ComponentGroup from '@de/components/visualization/ComponentGroup.vue'
import UserViewGroup from '@de/custom-component/component-group/UserViewGroup.vue'
import QueryGroup from '@de/custom-component/component-group/QueryGroup.vue'
import MediaGroup from '@de/custom-component/component-group/MediaGroup.vue'
import TextGroup from '@de/custom-component/component-group/TextGroup.vue'
...
import MultiplexingCanvas from '@de/views/common/MultiplexingCanvas.vue'
import { useI18n } from '@de/hooks/web/useI18n'
import { getPanelAllLinkageInfo, saveLinkage } from '@de/api/visualization/linkage'
...
import {
  ...
  findAllViewsId,
  initCanvasData
} from '@de/utils/canvasUtils'
import { useEmitt } from '@de/hooks/web/useEmitt'
import { copyStoreWithOut } from '@de/store/modules/data-visualization/copy'
import TabsGroup from '@de/custom-component/component-group/TabsGroup.vue'
import DeResourceGroupOpt from '@de/views/common/DeResourceGroupOpt.vue'
import OuterParamsSet from '@de/components/visualization/OuterParamsSet.vue'
import { XpackComponent } from '@de/components/plugin'
import DbMoreComGroup from '@de/custom-component/component-group/DbMoreComGroup.vue'
import { useCache } from '@de/hooks/web/useCache'
import DeFullscreen from '@de/components/visualization/common/DeFullscreen.vue'
import DeAppApply from '@de/views/common/DeAppApply.vue'
import { useUserStoreWithOut } from '@de/store/modules/user'
import { updatePublishStatus } from '@de/api/visualization/dataVisualization'
const { t } = useI18n()
