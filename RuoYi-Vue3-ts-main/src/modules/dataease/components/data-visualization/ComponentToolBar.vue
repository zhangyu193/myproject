...
import dvReposition from '@de/assets/svg/dv-reposition.svg'
import dvMax from '@de/assets/svg/dv-max.svg'
import dvMin from '@de/assets/svg/dv-min.svg'
...
} from '@de/utils/changeComponentsSizeWithScale'
