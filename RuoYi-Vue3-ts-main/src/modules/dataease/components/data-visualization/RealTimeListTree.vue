...
import pictureGroupOrigin from '@de/assets/svg/picture-group-origin.svg'
...
import RealTimeGroup from '@de/components/data-visualization/RealTimeGroup.vue'
...
import { checkJoinGroup, syncViewTitle } from '@de/utils/canvasUtils'
