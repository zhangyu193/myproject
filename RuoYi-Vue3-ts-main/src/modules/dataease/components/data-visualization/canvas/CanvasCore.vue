...
import $ from 'jquery'
import { _$, isPreventDrop } from '@de/utils/utils'
import ContextMenu from './ContextMenu.vue'
import MarkLine from './MarkLine.vue'
import Area from './Area.vue'
import eventBus from '@de/utils/eventBus'
import { changeStyleWithScale } from '@de/utils/translate'
...
import { contextmenuStoreWithOut } from '@de/store/modules/data-visualization/contextmenu'
import { storeToRefs } from 'pinia'
import findComponent from '@de/utils/components'
import _ from 'lodash'
import DragShadow from '@de/components/data-visualization/canvas/DragShadow.vue'
import {
  canvasSave,
  componentPreSort,
  findDragComponent,
...
import UserViewEnlarge from '@de/components/visualization/UserViewEnlarge.vue'
...
import PointShadow from '@de/components/data-visualization/canvas/PointShadow.vue'
import DragInfo from '@de/components/visualization/common/DragInfo.vue'
import { activeWatermarkCheckUser } from '@de/components/watermark/watermark'
import PopArea from '@de/custom-component/pop-area/Component.vue'
import DatasetParamsComponent from '@de/components/visualization/DatasetParamsComponent.vue'
import DeGrid from '@de/components/data-visualization/DeGrid.vue'
import DeGridScreen from '@de/components/data-visualization/DeGridScreen.vue'
import GroupAreaShadow from '@de/custom-component/group-area/ComponentShadow.vue'
