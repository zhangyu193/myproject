...
import mobileCheckbox from '@de/assets/svg/mobile-checkbox.svg'
import replaceOutlined from '@de/assets/svg/icon_replace_outlined.svg'
...
} from '@de/utils/calculateComponentPositionAndSize'
import { mod360 } from '@de/utils/translate'
...
import { downloadCanvas2, imgUrlTrans } from '@de/utils/imgUtils'
import Icon from '@de/components/icon-custom/src/Icon.vue'
import ComponentEditBar from '@de/components/visualization/ComponentEditBar.vue'
...
import { groupSizeStyleAdaptor, groupStyleRevert, tabInnerStyleRevert } from '@de/utils/style'
import {
  checkJoinTab,
  isDashboard,
  isGroupCanvas,
...
import Board from '@de/components/de-board/Board.vue'
import { activeWatermarkCheckUser, removeActiveWatermark } from '@de/components/watermark/watermark'
