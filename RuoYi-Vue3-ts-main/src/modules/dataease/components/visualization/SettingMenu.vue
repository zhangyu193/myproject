...
import { getViewLinkageGather } from '@de/api/visualization/linkage'
...
import TabCarouselDialog from '@de/components/visualization/TabCarouselDialog.vue'
import HyperlinksDialog from '@de/components/visualization/HyperlinksDialog.vue'
const { t } = useI18n()
