...
import CommonStyleSet from '@de/custom-component/common/CommonStyleSet.vue'
...
import TabBackgroundOverall from '@de/custom-component/de-tabs/TabBackgroundOverall.vue'
