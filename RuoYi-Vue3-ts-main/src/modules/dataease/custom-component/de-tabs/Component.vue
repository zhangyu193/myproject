...
import { canvasChangeAdaptor, findComponentIndexById, isDashboard } from '@de/utils/canvasUtils'
import DeCustomTab from '@de/custom-component/de-tabs/DeCustomTab.vue'
...
import { dataVTabComponentAdd, groupSizeStyleAdaptor } from '@de/utils/style'
import { deepCopyTabItemHelper } from '@de/store/modules/data-visualization/copy'
