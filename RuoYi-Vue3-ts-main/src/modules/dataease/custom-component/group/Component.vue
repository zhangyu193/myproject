...
import CanvasGroup from '@de/custom-component/common/CanvasGroup.vue'
import { deepCopy } from '@de/utils/utils'
import { DEFAULT_CANVAS_STYLE_DATA_DARK } from '@de/views/chart/components/editor/util/dataVisualization'
import { groupSizeStyleAdaptor } from '@de/utils/style'
