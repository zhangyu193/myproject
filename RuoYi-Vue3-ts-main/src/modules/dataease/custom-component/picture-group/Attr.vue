...
import PictureGroupUploadAttr from '@de/custom-component/picture-group/PictureGroupUploadAttr.vue'
import PictureGroupDatasetSelect from '@de/custom-component/picture-group/PictureGroupDatasetSelect.vue'
import CarouselSetting from '@de/custom-component/common/CarouselSetting.vue'
import PictureGroupThreshold from '@de/custom-component/picture-group/PictureGroupThreshold.vue'
defineProps({
  themes: {
