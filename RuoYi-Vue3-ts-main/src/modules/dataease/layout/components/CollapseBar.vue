...
import icon_sideFold_outlined from '@de/assets/svg/icon_side-fold_outlined.svg'
import icon_sideExpand_outlined from '@de/assets/svg/icon_side-expand_outlined.svg'
