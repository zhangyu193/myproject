...
import topEnterpriseTrial from '@de/assets/svg/top-enterprise-trial.svg'
import topHelpDoc from '@de/assets/svg/top-help-doc.svg'
import topProductBbs from '@de/assets/svg/top-product-bbs.svg'
import topTechnology from '@de/assets/svg/top-technology.svg'
import { useI18n } from '@de/hooks/web/useI18n'
import docs from '@de/assets/svg/icon-maybe_outlined.svg'
import { computed } from 'vue'
import { Icon } from '@de/components/icon-custom'
import TopDocCard from '@de/layout/components/TopDocCard.vue'
