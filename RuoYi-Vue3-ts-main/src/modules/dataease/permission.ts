...
import { getDefaultSettings } from '@de/api/common'
import { useNProgress } from '@de/hooks/web/useNProgress'
import { usePermissionStoreWithOut, pathValid, getFirstAuthMenu } from '@de/store/modules/permission'
...
import { isMobile, checkPlatform, isLarkPlatform, isPlatformClient } from '@de/utils/utils'
