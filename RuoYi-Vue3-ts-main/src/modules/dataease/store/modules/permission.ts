...
import { routes } from '@de/router'

import { generateRoutesFn2 } from '@de/router/establish'
import { store } from '../index'
import { cloneDeep } from 'lodash-es'
import NotFoundPage from '@de/views/404/index.vue'
...
export const usePermissionStoree = defineStore('de-permission', {
...
export const usePermissionStoreWithOut = () => {
  return usePermissionStoree(store)
}

export const pathValid = path => {
  const permissionStore = usePermissionStoree(store)
