...
import { findNewComponentFromList } from '@de/custom-component/component-list' // 左侧列表数据
...
import { getCanvasStyle, syncShapeItemStyle } from '@de/utils/style'
...
import { isMainCanvas, isDashboard } from '@de/utils/canvasUtils'
