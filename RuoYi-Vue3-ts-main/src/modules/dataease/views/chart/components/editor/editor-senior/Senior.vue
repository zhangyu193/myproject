...
import FunctionCfg from '@de/views/chart/components/editor/editor-senior/components/FunctionCfg.vue'
import ScrollCfg from '@de/views/chart/components/editor/editor-senior/components/ScrollCfg.vue'
import AssistLine from '@de/views/chart/components/editor/editor-senior/components/AssistLine.vue'
import Threshold from '@de/views/chart/components/editor/editor-senior/components/Threshold.vue'
import MapMapping from '@de/views/chart/components/editor/editor-senior/components/MapMapping.vue'
...
import LinkJumpSet from '@de/components/visualization/LinkJumpSet.vue'
import LinkageSet from '@de/components/visualization/LinkageSet.vue'
import { canvasSave } from '@de/utils/canvasUtils'
import {
  queryVisualizationJumpInfo,
  removeJumpSet,
  updateJumpSetActive
} from '@de/api/visualization/linkJump'
import { dvMainStoreWithOut } from '@de/store/modules/data-visualization/dvMain'
import {
  getPanelAllLinkageInfo,
  removeLinkage,
  updateLinkageActive
} from '@de/api/visualization/linkage'
...
import BubbleAnimateCfg from '@de/views/chart/components/editor/editor-senior/components/BubbleAnimateCfg.vue'
import { XpackComponent } from '@de/components/plugin'
import CarouselSetting from '@de/custom-component/common/CarouselSetting.vue'
import { Icon } from 'vant'
import CommonEvent from '@de/custom-component/common/CommonEvent.vue'
