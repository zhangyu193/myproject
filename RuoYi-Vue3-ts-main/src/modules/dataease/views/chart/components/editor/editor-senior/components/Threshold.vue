...
import { DEFAULT_THRESHOLD } from '@de/views/chart/components/editor/util/chart'
import TableThresholdEdit from '@de/views/chart/components/editor/editor-senior/components/dialog/TableThresholdEdit.vue'
import TextLabelThresholdEdit from '@de/views/chart/components/editor/editor-senior/components/dialog/TextLabelThresholdEdit.vue'
import TextThresholdEdit from '@de/views/chart/components/editor/editor-senior/components/dialog/TextThresholdEdit.vue'
import LineThresholdEdit from '@de/views/chart/components/editor/editor-senior/components/dialog/LineThresholdEdit.vue'
import { fieldType } from '@de/utils/attr'
import { defaultsDeep } from 'lodash-es'
import { iconFieldMap } from '@de/components/icon-group/field-list'
import PictureGroupThresholdEdit from '@de/views/chart/components/editor/editor-senior/components/dialog/PictureGroupThresholdEdit.vue'
