...
import icon_info_filled from '@de/assets/svg/icon_info_filled.svg'
...
import PictureItem from '@de/custom-component/picture-group/PictureItem.vue'
import PictureOptionPrefix from '@de/custom-component/picture-group/PictureOptionPrefix.vue'
