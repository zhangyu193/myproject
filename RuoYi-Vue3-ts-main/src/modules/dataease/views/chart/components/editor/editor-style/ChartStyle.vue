...
import MiscSelector from '@de/views/chart/components/editor/editor-style/components/MiscSelector.vue'
import LabelSelector from '@de/views/chart/components/editor/editor-style/components/LabelSelector.vue'
import TooltipSelector from '@de/views/chart/components/editor/editor-style/components/TooltipSelector.vue'
import XAxisSelector from '@de/views/chart/components/editor/editor-style/components/XAxisSelector.vue'
import YAxisSelector from '@de/views/chart/components/editor/editor-style/components/YAxisSelector.vue'
import DualYAxisSelector from '@de/views/chart/components/editor/editor-style/components/DualYAxisSelector.vue'
import TitleSelector from '@de/views/chart/components/editor/editor-style/components/TitleSelector.vue'
import LegendSelector from '@de/views/chart/components/editor/editor-style/components/LegendSelector.vue'
import SummarySelector from '@de/views/chart/components/editor/editor-style/components/SummarySelector.vue'
import { dvMainStoreWithOut } from '@de/store/modules/data-visualization/dvMain'
import { storeToRefs } from 'pinia'
import CollapseSwitchItem from '@de/components/collapse-switch-item/src/CollapseSwitchItem.vue'
import { ElCollapse, ElCollapseItem } from 'element-plus-secondary'
import BasicStyleSelector from '@de/views/chart/components/editor/editor-style/components/BasicStyleSelector.vue'
import SymbolicStyleSelector from '@de/views/chart/components/editor/editor-style/components/SymbolicStyleSelector.vue'
import DualBasicStyleSelector from '@de/views/chart/components/editor/editor-style/components/DualBasicStyleSelector.vue'
import ComponentPosition from '@de/components/visualization/common/ComponentPosition.vue'
import BackgroundOverallCommon from '@de/components/visualization/component-background/BackgroundOverallCommon.vue'
import TableHeaderSelector from '@de/views/chart/components/editor/editor-style/components/table/TableHeaderSelector.vue'
import TableCellSelector from '@de/views/chart/components/editor/editor-style/components/table/TableCellSelector.vue'
import TableTotalSelector from '@de/views/chart/components/editor/editor-style/components/table/TableTotalSelector.vue'
import MiscStyleSelector from '@de/views/chart/components/editor/editor-style/components/MiscStyleSelector.vue'
import IndicatorValueSelector from '@de/views/chart/components/editor/editor-style/components/IndicatorValueSelector.vue'
import IndicatorNameSelector from '@de/views/chart/components/editor/editor-style/components/IndicatorNameSelector.vue'
import QuadrantSelector from '@de/views/chart/components/editor/editor-style/components/QuadrantSelector.vue'
import FlowMapLineSelector from '@de/views/chart/components/editor/editor-style/components/FlowMapLineSelector.vue'
import FlowMapPointSelector from '@de/views/chart/components/editor/editor-style/components/FlowMapPointSelector.vue'
import CommonBorderSetting from '@de/custom-component/common/CommonBorderSetting.vue'
import { snapshotStoreWithOut } from '@de/store/modules/data-visualization/snapshot'
import BulletTargetSelector from '@de/views/chart/components/editor/editor-style/components/bullet/BulletTargetSelector.vue'
import BulletMeasureSelector from '@de/views/chart/components/editor/editor-style/components/bullet/BulletMeasureSelector.vue'
import BulletRangeSelector from '@de/views/chart/components/editor/editor-style/components/bullet/BulletRangeSelector.vue'
