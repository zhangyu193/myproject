...
import CustomColorStyleSelect from '@de/views/chart/components/editor/editor-style/components/CustomColorStyleSelect.vue'
...
import { useLocaleStoreWithOut } from '@de/store/modules/locale'
import { useMapStoreWithOut } from '@de/store/modules/map'
import { queryMapKeyApi } from '@de/api/setting/sysParameter'
import {
  gaodeMapStyleOptions,
  qqMapStyleOptions,
  tdtMapStyleOptions
} from '@de/views/chart/components/js/panel/charts/map/common'
