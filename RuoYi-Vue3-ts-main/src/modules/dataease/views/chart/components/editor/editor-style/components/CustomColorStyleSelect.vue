...
import { COLOR_CASES, COLOR_PANEL } from '@de/views/chart/components/editor/util/chart'
import GradientColorSelector from '@de/views/chart/components/editor/editor-style/components/GradientColorSelector.vue'
import { getMapColorCases, stepsColor } from '@de/views/chart/components/js/util'
