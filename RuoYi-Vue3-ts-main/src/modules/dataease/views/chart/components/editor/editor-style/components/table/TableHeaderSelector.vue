...
import { COLOR_PANEL, DEFAULT_TABLE_HEADER } from '@de/views/chart/components/editor/util/chart'
...
import { getLeafNodes } from '@de/views/chart/components/js/panel/common/common_table'
