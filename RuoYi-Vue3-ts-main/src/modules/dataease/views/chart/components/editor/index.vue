...
import icon_copy_outlined from '@de/assets/svg/icon_copy_outlined.svg'
import {
  PropType,
  reactive,
  ref,
...
import QuotaItem from '@de/views/chart/components/editor/drag-item/QuotaItem.vue'
import DragPlaceholder from '@de/views/chart/components/editor/drag-item/DragPlaceholder.vue'
import FilterTree from './filter/FilterTree.vue'
import ChartStyle from '@de/views/chart/components/editor/editor-style/ChartStyle.vue'
import VQueryChartStyle from '@de/views/chart/components/editor/editor-style/VQueryChartStyle.vue'
import Senior from '@de/views/chart/components/editor/editor-senior/Senior.vue'
import QuotaFilterEditor from '@de/views/chart/components/editor/filter/QuotaFilterEditor.vue'
import ResultFilterEditor from '@de/views/chart/components/editor/filter/ResultFilterEditor.vue'
import { ElIcon } from 'element-plus-secondary'
import DrillItem from '@de/views/chart/components/editor/drag-item/DrillItem.vue'
import { dvMainStoreWithOut } from '@de/store/modules/data-visualization/dvMain'
import { storeToRefs } from 'pinia'
import { BASE_VIEW_CONFIG, getViewConfig } from '@de/views/chart/components/editor/util/chart'
import ChartType from '@de/views/chart/components/editor/chart-type/ChartType.vue'
import { useRouter, useRoute } from 'vue-router'
import CompareEdit from '@de/views/chart/components/editor/drag-item/components/CompareEdit.vue'
import ValueFormatterEdit from '@de/views/chart/components/editor/drag-item/components/ValueFormatterEdit.vue'
import CustomSortEdit from '@de/views/chart/components/editor/drag-item/components/CustomSortEdit.vue'
import SortPriorityEdit from '@de/views/chart/components/editor/drag-item/components/SortPriorityEdit.vue'
import { snapshotStoreWithOut } from '@de/store/modules/data-visualization/snapshot'
import CalcFieldEdit from '@de/views/visualized/data/dataset/form/CalcFieldEdit.vue'
import { getFieldName, guid } from '@de/views/visualized/data/dataset/form/util'
import { cloneDeep, forEach, get, debounce, set, concat, keys } from 'lodash-es'
import { deleteField, saveField } from '@de/api/dataset'
import { getWorldTree, listCustomGeoArea } from '@de/api/map'
import chartViewManager from '@de/views/chart/components/js/panel'
import DatasetSelect from '@de/views/chart/components/editor/dataset-select/DatasetSelect.vue'
import { useDraggable } from '@vueuse/core'
import { PluginComponent } from '@de/components/plugin'
import { Field, getFieldByDQ, copyChartField, deleteChartField } from '@de/api/chart'
import ChartTemplateInfo from '@de/views/chart/components/editor/common/ChartTemplateInfo.vue'
...
} from '@de/components/icon-group/field-calculated-list'
import { useCache } from '@de/hooks/web/useCache'
import { canvasSave } from '@de/utils/canvasUtils'
