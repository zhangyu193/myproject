...
import { getPadding, setGradientColor } from '@de/views/chart/components/js/panel/common/common_antv'
...
} from '@de/views/chart/components/js/panel/charts/others/sankey-common'
