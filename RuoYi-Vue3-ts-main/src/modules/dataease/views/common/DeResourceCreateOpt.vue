...
import { showTemplateList } from '@de/api/template'
import { useI18n } from '@de/hooks/web/useI18n'
import { computed, reactive, ref, watch } from 'vue'
import { imgUrlTrans } from '@de/utils/imgUtils'
import { ElMessage } from 'element-plus-secondary'
import { decompression } from '@de/api/visualization/dataVisualization'
import DeTemplatePreviewList from '@de/views/common/DeTemplatePreviewList.vue'
const { t } = useI18n()
