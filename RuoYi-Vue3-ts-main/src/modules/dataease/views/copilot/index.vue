...
import activeBtn_copilot from '@de/assets/svg/active-btn_copilot.svg'
import btn_copilot from '@de/assets/svg/btn_copilot.svg'
import copilot from '@de/assets/svg/copilot.svg'
import icon_loading_outlined from '@de/assets/svg/icon_loading_outlined.svg'
...
import DialogueChart from '@de/views/copilot/DialogueChart.vue'
import { type Tree } from '@de/views/visualized/data/dataset/form/CreatDsGroup.vue'
