...
import { shortcutOption } from '@de/views/workbranch/ShortcutOption'
import { useRouter } from 'vue-router'
import { useCache } from '@de/hooks/web/useCache'
import Workbranch from '@de/views/mobile/components/Workbranch.vue'
import request from '@de/config/axios'
import nothingNone from '@de/assets/img/none.png'
