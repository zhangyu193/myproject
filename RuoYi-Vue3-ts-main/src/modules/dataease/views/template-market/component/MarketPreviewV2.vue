...
import marketExpand from '@de/assets/svg/market-expand.svg'
...
import { searchMarketPreview } from '@de/api/templateMarket'
import { onMounted, reactive, watch, ref } from 'vue'
import { useI18n } from '@de/hooks/web/useI18n'
import TemplateMarketPreviewItem from '@de/views/template-market/component/TemplateMarketPreviewItem.vue'
import { deepCopy, getActiveCategories } from '@de/utils/utils'
