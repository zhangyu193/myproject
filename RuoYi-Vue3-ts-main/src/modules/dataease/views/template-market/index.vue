...
import no_result from '@de/assets/svg/no_result.svg'
import { searchMarket } from '@de/api/templateMarket'
...
import MarketPreviewV2 from '@de/views/template-market/component/MarketPreviewV2.vue'
import { imgUrlTrans } from '@de/utils/imgUtils'
import CategoryTemplateV2 from '@de/views/template-market/component/CategoryTemplateV2.vue'
import TemplateSkeleton from '@de/views/template-market/component/TemplateSkeleton.vue'
...
import { getActiveCategories } from '@de/utils/utils'
const { t } = useI18n()
