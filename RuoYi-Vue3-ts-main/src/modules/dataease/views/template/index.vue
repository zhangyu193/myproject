...
import deSearch from '@de/assets/svg/de-search.svg'
import dvEmpty from '@de/assets/svg/dv-empty.svg'
import dvNothing from '@de/assets/svg/dv-nothing.svg'
import {
  save,
  templateDelete,
  find,
  ...
  deleteCategory,
  batchDelete
} from '@de/api/template'
import elementResizeDetectorMaker from 'element-resize-detector'
import { computed, nextTick, onMounted, reactive, ref } from 'vue'
import { useI18n } from '@de/hooks/web/useI18n'
import { ElMessage, ElMessageBox } from 'element-plus-secondary'
import DeTemplateList from '@de/views/template/component/DeTemplateList.vue'

const { t } = useI18n()
const templateEditFormRef = ref(null)
const templateListRef = ref(null)
import DeTemplateImport from '@de/views/template/component/DeTemplateImport.vue'
import DeTemplateItem from '@de/views/template/component/DeTemplateItem.vue'
import DeCategoryChange from '@de/views/template/component/DeCategoryChange.vue'
