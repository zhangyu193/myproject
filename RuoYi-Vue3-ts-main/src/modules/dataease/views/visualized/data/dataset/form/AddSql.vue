...
import referencePlay from '@de/assets/svg/reference-play.svg'
import referenceSetting1 from '@de/assets/svg/reference-setting.svg'
import icon_preferences_outlined from '@de/assets/svg/icon_preferences_outlined.svg'
...
import referenceTable from '@de/assets/svg/reference-table.svg'
import icon_searchOutline_outlined from '@de/assets/svg/icon_search-outline_outlined.svg'
import icon_form_outlined from '@de/assets/svg/icon_form_outlined.svg'
...
import icon_textBox_outlined from '@de/assets/svg/icon_text-box_outlined.svg'
import icon_info_colorful from '@de/assets/svg/icon_info_colorful.svg'
import icon_playRound_outlined from '@de/assets/svg/icon_play-round_outlined.svg'
import { searchVariableApi } from '@de/api/variable'
import {
  ref,
  reactive,
  onMounted,
...
import { getTableField } from '@de/api/dataset'
import CodeMirror from './CodeMirror.vue'
import type { Field, DataSource } from './util'
import { getDatasourceList, getTables, getPreviewSql } from '@de/api/dataset'
...
import field_text from '@de/assets/svg/field_text.svg'
import field_value from '@de/assets/svg/field_value.svg'
import field_time from '@de/assets/svg/field_time.svg'
