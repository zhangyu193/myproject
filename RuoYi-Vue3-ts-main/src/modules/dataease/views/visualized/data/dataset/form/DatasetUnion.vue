...
import icon_fullAssociation from '@de/assets/svg/icon_full-association.svg'
import icon_intersect from '@de/assets/svg/icon_intersect.svg'
import icon_leftAssociation from '@de/assets/svg/icon_left-association.svg'
import icon_rightAssociation from '@de/assets/svg/icon_right-association.svg'
import icon_sql_outlined from '@de/assets/svg/icon_sql_outlined.svg'
import referenceTable from '@de/assets/svg/reference-table.svg'
import icon_moreVertical_outlined from '@de/assets/svg/icon_more-vertical_outlined.svg'
import { reactive, computed, ref, nextTick, inject, type Ref, watch, unref } from 'vue'
import AddSql from './AddSql.vue'
import { useI18n } from '@de/hooks/web/useI18n'
import zeroNodeImg from '@de/assets/img/drag.png'
...
import type { Table } from '@de/api/dataset'
