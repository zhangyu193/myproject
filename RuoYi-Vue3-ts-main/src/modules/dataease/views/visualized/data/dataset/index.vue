...
import { moveDatasetTree } from '@de/api/dataset'
...
import { save } from '@de/api/visualization/dataVisualization'
...
import RowAuth from '@de/views/chart/components/editor/filter/auth-tree/RowAuth.vue'

import {
  DEFAULT_CANVAS_STYLE_DATA_LIGHT,
  DEFAULT_CANVAS_STYLE_DATA_SCREEN_DARK
} from '@de/views/chart/components/editor/util/dataVisualization'
...
import { exportPermission, isFreeFolder } from '@de/utils/utils'
const { t } = useI18n()
...
const savee = ({ logic, items, errorMessage }) => {
  ...
  >
    ...
    >
      ...
      <el-form-item :label="$t('dataset.export_filter')" prop="expressionTree">
        <div class="tree-cont">
          <div class="content">
            <RowAuth @save="savee" ref="rowAuth" />
          </div>
        </div>
      </el-form-item>
    </el-form>
