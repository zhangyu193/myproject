      ...
      <el-col :span="12" style="height: 100%">
        ...
        >
          <div class="demo-preview">
            <img style="height: 100%" src="@de/assets/img/watermark-demo-light.png" />
          </div>
          <div class="demo-preview" style="margin-top: 15px">
            <img style="height: 100%" src="@de/assets/img/watermark-demo-dark.png" />
          </div>
        </div>
      </el-col>
    </el-row>
...
import { watermarkFind, watermarkSave } from '@de/api/watermark'
import { ElMessage } from 'element-plus-secondary/es'
import { personInfoApi } from '@de/api/user'
import { getNow, watermark } from '@de/components/watermark/watermark'
import { useI18n } from '@de/hooks/web/useI18n'
import ParamsTips from '@de/views/watermark/ParamsTips.vue'
const { t } = useI18n()
