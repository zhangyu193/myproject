...
import icon_template_colorful from '@de/assets/svg/icon_template_colorful.svg'
...
import { searchMarketRecommend } from '@de/api/templateMarket'
import TemplateBranchItem from '@de/views/workbranch/TemplateBranchItem.vue'
...
import { queryShareBaseApi } from '@de/api/visualization/dataVisualization'
